...
from donations.payment_gateways.stripe.views import create_checkout_session, create_setup_checkout_session, verify_stripe_response, return_from_stripe, cancel_from_stripe, return_from_setup_stripe, cancel_from_setup_stripe
...
urlpatterns = [
    ...
    path('update-recurring-card/<int:id>/', views.update_recurring_card, name='update-recurring-card'),
    ...
    path('create-stripe-setup-session/', create_setup_checkout_session, name='create-stripe-setup-session'),
    ...
    path('return-from-setup-stripe/', return_from_setup_stripe, name='return-from-setup-stripe'),
    path('cancel-from-setup-stripe/', cancel_from_setup_stripe, name='cancel-from-setup-stripe'),
