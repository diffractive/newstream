...
from donations.payment_gateways.paypal.views import create_paypal_transaction, verify_paypal_response, verify_paypal_response_legacy, capture_paypal_order, return_from_paypal, cancel_from_paypal
...
urlpatterns = [
    ...
    path('verify-paypal-response-legacy/', verify_paypal_response_legacy, name='verify-paypal-response-legacy'),
