...
# -
clear_all_emails()
cancel_url = '/en/donations/cancel-from-stripe-card-update/'
...
wait_element(driver, '//h1[text()="My recurring donations"]')
grabber.capture_screen('cancel_update', 'Return to recurring donations')
